...
const UserCard = ({ userInfo }) => {
  ...
  return (
    <div className="rounded-md mt-3 p-4 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[50%] shadow-md cursor-pointer transition-transform duration-300 ease-out hover:shadow-xl bg-slate-100">
      {/* img + username + company */}
      <div className="grid grid-cols-1 sm:grid-cols-[30%_70%] items-center gap-3 bg-slate-200 p-4 rounded-md">
        ...
        <div className="flex justify-center space-x-5 ms-10 sm:m-0 items-center">
          <p className="text-center text-slate-600">
            username:{" "}
            <span className="text-slate-500">@{username || "unknown"}</span>
          </p>
          <p className="text-center text-slate-600 text-sm">
            Company:{" "}
            <span className="text-slate-500">{company || "unknown"}</span>{" "}
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 p-6 rounded-md">
        ...
        <p className="text-gray-600">{bio || "unknown"}</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[70%_30%] items-center justify-center gap-3 bg-slate-200 p-4 rounded-md mt-5 shadow-xl">
        ...
        <div className="bg-gray-600 p-3 text-center rounded-md text-slate-300">
          <p>
            Joined At{" "}
