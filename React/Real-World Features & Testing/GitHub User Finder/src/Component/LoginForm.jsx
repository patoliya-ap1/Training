          ...
          <Form>
            ...
            <div className="space-x-3 mt-5">
              <button
                ...
                type="submit"
                className="px-3 py-2 bg-sky-800 rounded-md text-slate-200 cursor-pointer hover:bg-sky-600"
              >
                login
              </button>
              <button
                ...
                className="px-3 py-2 bg-gray-700 rounded-md text-slate-200 cursor-pointer hover:bg-gray-600"
              >
                Signup
              </button>
            </div>
